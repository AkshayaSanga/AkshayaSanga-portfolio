        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-5 text-gray-400 leading-relaxed font-body text-base">
              <p>
                I'm <span className="text-blue-400 font-semibold">Akshaya Sanga</span>, a final-year B.Tech CSE student
              ...
              <p>
                ...
                <span className="text-gray-100"> IBM SkillsBuild x Edunet Foundation</span>.
              </p>
              <p>
                I've solved <span className="text-blue-400 font-semibold">202 problems on LeetCode</span> (81 Easy, 92 Medium, 29 Hard)
            ...
            >
              ...
              <div>
                ...
                <p className="font-mono text-xs text-gray-500 mt-1">Vignan Institute of Tech & Science • CGPA: 8.4 • Expected 2027</p>
              </div>
            </motion.div>
